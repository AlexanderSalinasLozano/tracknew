<?
		...
		if ($email != "")
		{
			if ($seccode == $_SESSION["seccode"])
			{
				...
				if ($num > 0)
				{
				   ...
				   //$url_recover = $gsValues['URL_ROOT'].'/recoverpass.php?cmd=recover&token='.$token;
					...
					else
					{
						...
						// CURLOPT_URL => 'https://www.gpsimple.cl/track/func/fn_connect.php',
						...
						// CURLOPT_POSTFIELDS => array('cmd' => 'recover','token' => $token),
						// CURLOPT_HTTPHEADER => array(
						// 	'Cookie: PHPSESSID=doo7hlcc2j0m7bp1825rfq84l0; gs_language=spanish'
						// ),
						// ));
	...
	if (@$_POST['cmd'] == 'recover_url_app')
	{

		echo "hola desde casa";
