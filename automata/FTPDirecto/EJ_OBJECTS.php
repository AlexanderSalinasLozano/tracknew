...
$query = "CALL st_Ej_ObtieneObjetos()"; 
$stmt = $conn->query( $query ); 

$file = fopen("C:/inetpub/wwwroot/track/automata/objects.csv", "w+");
...
$file = "C:/inetpub/wwwroot/track/automata/objects.csv"; 
$remote_file = "objects.csv"; 
