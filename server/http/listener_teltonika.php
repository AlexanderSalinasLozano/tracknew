<?php
    ...
    // // $url = 'http://35.226.245.223/api/interpreter?data=[out:json];way(around:05.0,'.$loc['lat'].','.$loc['lng'].');out;';
          $url = 'http://10.128.15.198/api/interpreter?data=[out:json];way(around:06.0,'.$loc['lat'].','.$loc['lng'].');out;';
