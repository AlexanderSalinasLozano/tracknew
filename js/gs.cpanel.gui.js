...
function switchCPTab(name)
{
	...
	if (document.getElementById("top_panel_button_manage_dashboard") != undefined)
	{
		document.getElementById("top_panel_button_manage_dashboard").className = "dashboard-server-btn";
	}
	...
	switch (name)
	{
		case "user_list":
			...
			if (document.getElementById("top_panel_button_manage_dashboard") != undefined)
			{
				document.getElementById("cpanel_manage_dashboard").style.display = 'none';
			}
		...
		case "manage_dashboard":
			document.getElementById("top_panel_button_manage_dashboard").className = "dashboard-server-btn active";
			...
			if (document.getElementById("top_panel_button_manage_dashboard") != undefined)
			{
				document.getElementById('cpanel_manage_dashboard').style.display = '';
			}
