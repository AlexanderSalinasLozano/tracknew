<?
	echo "<script>localStorage.removeItem('checkItem');</script>";
...
// if (strpos($url,'recover') !== false && strpos($url,'token') !== false) {
//     echo 'Car exists.';
// } else {
//     echo 'No cars.';
// }
...
<body id="login" onload="connectLoad()">
	...
	<div class="wrapper">
		<div class="inner-wrapper">
			...
			<? if(strpos($url,'recover') !== false && strpos($url,'token') !== false) {  ?>
			<div class="content">
				<div id="connect" class="content-block" style="display:none">
				...
				<div id="recover" class="content-block" style="display:none">
					<div class="row3">
				...
				<? if ($gsValues['ALLOW_REGISTRATION'] == "true"){?>
				<div id="register" class="content-block" style="display:none">
					<div class="row3">
				...
				<div id="connect" class="content-block" style="text-align:center;font-size:18">
					Se le a enviado una nueva clave a su correo, por favor siga las instrucciones para volver a iniciar sesión en la plataforma.
				</div>
