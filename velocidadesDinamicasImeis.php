<?php
	...
	// $q = "select imei from gs_objects where plate_number = 'LHGP91'";
   ...
   $ct = 1;
	while($row = mysqli_fetch_row($r)){
		...
		$imei = '864403041380206';

        echo('comenzando...');
		echo $imei;

		$q2  = "select dt_tracker,lat,lng from gs_object_data_864403041380206 where dt_tracker between '2021-08-09 00:00:00' and '2021-08-10 23:59:59' and speed > 11";
		...
		while($row2 = mysqli_fetch_row($r2)){
			...
			echo $imei;
				...
				$lng 		= $row2[2];
			       ...
			       $url = 'http://10.128.15.198/api/interpreter?data=[out:json];way(around:10.0,'.$lat.','.$lng.');out;';
