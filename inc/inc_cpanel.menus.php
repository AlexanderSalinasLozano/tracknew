...
echo  "<script>localStorage.setItem('checkItem', '".$_SESSION["username"]."')</script>"; ?>
...
<ul id="cpanel_object_list_grid_action_menu" class="menu">
   ...
   <? if ($_SESSION["username"] == "admin"){ ?>
        <li><a class="icon-upload" href="masivo/gpsMasivo/index.php" target="_blank" onclick=""><? echo 'Carga Masiva' ?></a></li>
   <? } ?>
