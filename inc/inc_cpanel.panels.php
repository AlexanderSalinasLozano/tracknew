	...
	<div id="top_panel">
		<div class="tp-menu left-menu">
			...
			<? } else {?>
			<div class="user-list-btn">
				<a title="<? echo $la['USER_LIST']; ?>" class="active" id="top_panel_button_user_list">
					<img src="theme/images/user.svg" />
					<!--<span id="user_list_stats"></span>-->
				</a>
			</div>
			...
			<? }  else {?>					
				<div class="object-list-btn">
				<a title="<? echo $la['OBJECT_LIST']; ?>" id="top_panel_button_object_list">
					<img src="theme/images/marker.svg" />
					<!--<span id="object_list_stats"></span>-->
				</a>
			</div>
			...
			<? }  else {?>					
			<div class="unused-object-list-btn">
				<a title="<? echo $la['UNUSED_OBJECT_LIST']; ?>" id="top_panel_button_unused_object_list">
				<img src="theme/images/marker-crossed.svg" />
				<!--<span id="unused_object_list_stats"></span>-->
				</a>
			</div>
			...
			<? if ($_SESSION["privileges"] == 'super_admin') { ?>
			<!-- <div class="dashboard-server-btn">
				<a title="Dashboard" id="top_panel_button_manage_dashboard" href="#" onClick="switchCPTab('manage_dashboard');">
					<img src="theme/images/dashboard.svg" />
				</a>
			</div> -->
			<? } ?>
