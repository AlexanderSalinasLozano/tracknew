		...
		<div class="block width60">
			<div class="container">
				...
				<div class="row2">
					...
					<div class="width70"><textarea id="dialog_template_message" class="inputbox" style="height:255px;" maxlength="50000"></textarea></div>
				</div>
			</div>
		</div>
			...
			<div class="width-1000">
				...
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width10">
							<input id="cpanel_manage_server_history_period" class="inputbox width100" onkeypress="return isNumberKey(event);" maxlength="4" placeholder="<? echo $la['EXAMPLE_SHORT']; ?> 30"/>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="width235">
							<div class="ui-img-container">
								<?
									...
									{
										echo '<img class="favicon" id="cpanel_manage_server_favicon" src="'.$gsValues['URL_ROOT'].'/favicon.ico" />';
									}
									else
					...
					<div class="row2">
						...
						<div class="width10">
							<select id="cpanel_manage_server_geocoder_service" class="select width100" />
                                ...
                                <option value="gpmap">GPMap</option>
							</select>
						</div>
					</div>
					<div class="row2">
