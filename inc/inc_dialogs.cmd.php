				...
				<div class="block width100">
					<div class="container last">
						<div class="row2">
							...
							<div class="width29"><select id="cmd_object_list" class="select-search width100" onchange="cmdTemplateList();"></select></div>
						        <div class="width1"></div>
							<div class="width20"><? echo $la['GATEWAY'];?></div>
							<div class="width30">
								<select id="cmd_gateway" class="select width100"/>
						...
						<div class="row2">
							...
							<div class="width29"><select id="cmd_template_list" class="select width100" onchange="cmdTemplateSwitch();"></select></div>
						        <div class="width1"></div>
							<div class="width20"><? echo $la['TYPE'];?></div>
							<div class="width30">
								<select id="cmd_type" class="select width100"/>
		...
		<div class="block width60">
			<div class="container">
				...
				<div class="row2">
					...
					<div class="width65">
						<select id="dialog_cmd_schedule_protocol" class="select-search width100" onchange="cmdScheduleSwitchProtocol();"></select>
					</div>
				</div>
				<div class="row2">
