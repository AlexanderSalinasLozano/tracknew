...
<div id="top_panel" style="z-index: 9999;">
	<div class="tp-menu left-menu">
		...
		<?php if ($_SESSION["username"] == "admin" || $_SESSION["username"] == "leonel@stech.cl" || $_SESSION["username"] == "claudio_leivaa@yahoo.es"  || $_SESSION["username"] == "cristian"){ ?>
	...
	<?php if ($_SESSION["privileges"] != 'viewer') { ?>
		...
		<? } ?>
	<?php if ($_SESSION["privileges_dtc"] == true ) { ?>
	...
	<? } ?>
		...
		<?php } ?>
		<?php if ($_SESSION["privileges_image_gallery"] == true){ ?>
