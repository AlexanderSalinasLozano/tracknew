<div id="dialog_object_add" title="<? echo $la['ADD_OBJECT'] ?>">		
        <div class="row">
                ...
                <div class="row2">
                        ...
                        <div class="width60"><select id="dialog_object_add_device" class="select-search width100"></select></div>
                </div>
                <div class="row2">
...
<div id="dialog_object_edit" title="<? echo $la['EDIT_OBJECT']; ?>">
        <div class="row">
                ...
                <div class="row2">
                        <div class="width40"><? echo $la['GPS_DEVICE']; ?></div>
                        <div class="width60"><select id="dialog_object_edit_device" class="select-search width100"></select></div>
                </div>
                <div class="row2">
                        <div class="width40"><? echo $la['SIM_CARD_NUMBER']; ?></div>
