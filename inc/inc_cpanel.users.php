                        ...
                        <div class="block width40">						
                                <div class="container">
                                        <div class="row">
                                                ...
                                                <div class="row2" style="visibility: hidden;">
                                        ...
                                        <? if (($_SESSION["privileges"] == 'super_admin') || ($_SESSION["privileges"] == 'admin')) { ?>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                                ...
                                                <div style="height: 460px; overflow-y: scroll;">
                                                        ...
                                                        <div class="row2">
                                                                ...
                                                                <div class="width20">
                                                                        <input id="dialog_user_edit_places_markers" class="inputbox width100" onkeypress="return isNumberKey(event);" maxlength="4" />
                                                                </div>
                                                        </div>
                                                        <div class="row2">
                                                                <div class="width50">
                                                                ...
                                                                <div class="width20">
                                                                        <input id="dialog_user_edit_places_routes" class="inputbox width100" onkeypress="return isNumberKey(event);" maxlength="4" />
                                                                </div>
                                                        </div>
                                                        <div class="row2">
                                                                <div class="width50">
                                                                ...
                                                                <div class="width20">
                                                                        <input id="dialog_user_edit_places_zones" class="inputbox width100" onkeypress="return isNumberKey(event);" maxlength="4" />
                                                                </div>
                                                        </div>
                                                        <div class="row2">
                                                                <div class="width50">
